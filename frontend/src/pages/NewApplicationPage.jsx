...
export default function NewApplicationPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setResult(data);
      // Scroll down to results after they load
      setTimeout(() => {
        document
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-[14px] text-on-surface-variant mt-0.5">
              Configure the parameters below to run the AI risk assessment
              model.
            </p>
          </div>
          {/* Clear results button — shown only when results exist */}
          {result && (
            <button
              onClick={handleReset}
        ...
        >
          {/* Section label when results are showing */}
          {result && (
            <p
